...
public class FileServiceImpl implements FileService {
	...
	@Override
	public GetObjectResponse download(String path, Long offset, Long length) throws Exception {
		GetObjectArgs.Builder builder = GetObjectArgs.builder()
			.bucket(minioProperties.getBucket())
			.offset(offset)
			.length(length)
			.object(path);
		log.debug("Download File, Bucket: {}, Path: {}, Range: {}", minioProperties.getBucket(), path, offset + "-" + length);
